...
def simulation(breite, personen, zeit_infiziert, infiziert, inf_distanz, inf_wahrscheinlichkeit, max_kontakte, abstandsregelung, interval, zeige_graph):
    startx = 0
    starty = 0
        ...
        for i in range(personen):
            for k in range(personen):
                if liste[i].zustand == 1:
                    ...
                    if liste[k].zustand == 0 and distanz <= inf_distanz:
                        a = random.random()
